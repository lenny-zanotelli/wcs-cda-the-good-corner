...
export type GetAllAdsQuery = { __typename?: 'Query', getAllAds: Array<{
  ads: any; __typename?: 'Ad', id: string, title: string, description: string, picture: string, location: string, owner: string, price: number, createdAt: any, category?: { __typename?: 'Category', id: string, name: string } | null 
}> };
...
export type GetAdByIdQuery = { __typename?: 'Query', getAdById?: { __typename?: 'Ad', id: string, title: string, price: number, description: string, owner: string, picture: string, location: string } | null };
